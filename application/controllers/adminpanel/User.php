...
class User extends Admin_Controller {
	...
	function index($page_no=1)
	{
        ...
        $data_list = $this->Member_model->listinfo($where,'*',$orderby, $page_no,
				$this->Member_model->page_size,'',$this->Member_model->page_size,page_list_url('adminpanel/user/index',true));
